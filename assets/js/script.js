...
var slide1 = new Slide(
   "Night",
   "8 pm",
   "public/images/Kdel.gif",
   "https://kiev.vremja.org/"
);
...
function buildSlider(){
   ...
   for(var i = 0; i < slideArray.length; i++) {
       myHTML += "<div id='" + slideArray[i].id +
           ...
           "<h1 class='sliderText'>" + slideArray[i].title + "</h1>" +
           "<h4 class='sliderText'>" + slideArray[i].subtitle + "</h4>" +
